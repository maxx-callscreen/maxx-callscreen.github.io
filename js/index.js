...
eval("module.exports = {\"offering\":[{\"default\":true,\"id\":\"medical\",\"name\":\"Medical\",\"description\":\"Catch lifesaving breakthroughs and accelerate drug development. Discover new treatments and devices, and actively engage. See where research is heading and how efforts are being focused. Helping: Research & Development, Business Development, External and Open Innovation.\",\"image\":\"a\"},{\"id\":\"chemicals\",\"name\":\"Chemicals\",\"description\":\"Keep up with new formulations and novel processes. Identify new chemicals or new ways to develop and advance existing materials and processes. Helping: Process Engineers, Research & Development, Business Development, External and Open Innovation.\",\"image\":\"a\"},{\"id\":\"technology\",\"name\":\"Technology\",\"description\":\"Never fall behind ongoing updates. Stay up to date on emerging tech trends that will help guide investment and acquisition, allowing for better decisions. Helping: Technology Scouting, Research & Development, Business Development, External and Open Innovation.\",\"image\":\"a\"},{\"id\":\"food-beverage\",\"name\":\"Food & Beverage\",\"description\":\"Find out how to develop to your customers tastes. Customers tastes and interests are evolving, get ahead of the curve. Helping: Research & Development, Business Development, External and Open Innovation.\",\"image\":\"a\"},{\"id\":\"More\",\"name\":\"Other Industries\",\"description\":\"With our scientific and technology publications expanding daily, Resolute has the most comprehensive data for staying up to date in your industry.\",\"image\":\"a\"}]};\n\n//# sourceURL=webpack:///./src/app/components/service-data.json?");
...
eval("module.exports = {\"offering\":[{\"default\":true,\"id\":\"competitive-intelligence\",\"name\":\"Competitive Intelligence\",\"description\":\"Check out what competitors are working on, filing for, investing or acquiring. Auto generated snapshots gives you a look into company trends and allow you to gain insights on what to expect next.\",\"image\":\"/assets/comp_intel.svg\"},{\"id\":\"market-landscape\",\"name\":\"Market Landscape\",\"description\":\"Identify key players in new or familiar spaces by a variety of factors such as filings, technologies, investments and acquisitions. Map out gaps in coverage for any field and quickly build your strategy.\",\"image\":\"/assets/Heatmaptest.svg\"},{\"id\":\"tech-scouting\",\"name\":\"Technology Scouting\",\"description\":\"Discover emerging technology from multiple external sources and compare in real time. Engage with research institutions and universities looking to license proprietary technologies.\",\"image\":\"/assets/sunburst.gif\"},{\"id\":\"ip-analysis\",\"name\":\"IP Analysis\",\"description\":\"Make your prior art searches easier than ever with automatic connections to non-patent literature sources. Save time by visualizing multiple patent documents.\",\"image\":\"/assets/comp_intel.svg\"},{\"id\":\"trend-insights\",\"name\":\"Trend Insights\",\"description\":\"Find out what to expect next with easy-to-use visuals that reveal interesting patterns in any given area. Reveal signals using external data or your own internal data.\",\"image\":\"http://ilumen.com/test/images/svg/trend-chart.svg\"}]};\n\n//# sourceURL=webpack:///./src/app/components/solution-data.json?");
